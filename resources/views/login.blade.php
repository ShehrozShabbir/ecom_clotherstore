...
<head>
    ...
    <title>Login &mdash; Fashion</title>
    ...
    <!-- CSS Libraries -->
    <link rel="stylesheet" href="{{url('admin/modules/bootstrap-social/bootstrap-social.css')}}">
                ...
                <div class="row">
                    <div
                        ...
                        <div class="login-brand">
                            <img src="assets/logo/logo-edduby1.png" alt="logo" width="150" class="">
                        </div>
